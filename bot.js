...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('✅ ❤️☠︻╦̵̵͇̿̿̿̿╤─AJ-BOT-SIR࿐☠ 💙 working aan😎!')
        );
        ...
        if (config.WORKTYPE == 'public') {
            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                ...
                if (conn.user.jid === '@s.whatsapp.net') {
                    ...
                    await conn.sendMessage(conn.user.jid, '*❤️☠︻╦̵̵͇̿̿̿̿╤─AJ-BOT-SIR࿐☠ 💙 BOT ELLAM SETTAYI😇*', MessageType.text);
                }
            }
            else {
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~❤️☠︻╦̵̵͇̿̿̿̿╤─AJ-BOT-SIR࿐☠ 💙~*' +
